/*
 * Copyright (C) 2022 HAW Hamburg <michel.rottleuthner@haw-hamburg.de>
 *
 ...
 *
 * @file
 * @brief           ESP32 specific configuration definitions for the generic clock configuration module
 *
 *
