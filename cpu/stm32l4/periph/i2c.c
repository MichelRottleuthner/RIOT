...
int i2c_init_master(i2c_t dev, i2c_speed_t speed)
{
    ...
    /*
     * Speed configuration:
     * Example values can be found in the STM32L4x6 Reference manual RM0351
     * with f_I2CCLK = 48MHz
    ...
    switch (speed) {
        case I2C_SPEED_LOW:
            presc  = 0x0B;
            scll   = 0xC7;  /* t_SCLL   = 50us */
            sclh   = 0xC3;  /* t_SCLH   = 49us */
            sdadel = 0x02;  /* t_SDADEL = 500ns */
            scldel = 0x04;  /* t_SCLDEL = 1250ns */
            break;

        case I2C_SPEED_NORMAL:
            presc  = 0x0B;
            scll   = 0x13;  /* t_SCLL   = 5.0us */
            sclh   = 0x0F;  /* t_SCLH   = 4.0us */
            sdadel = 0x02;  /* t_SDADEL = 500ns */
            scldel = 0x04;  /* t_SCLDEL = 1250ns */
            break;
        ...
        case I2C_SPEED_FAST:
            presc  = 0x05;
            scll   = 0x09;  /* t_SCLL   = 1250ns */
            sclh   = 0x03;  /* t_SCLH   = 500ns */
            sdadel = 0x03;  /* t_SDADEL = 375ns */
            scldel = 0x03;  /* t_SCLDEL = 500ns */
            break;

        case I2C_SPEED_FAST_PLUS:
            presc  = 0x05;
            scll   = 0x03;  /* t_SCLL   = 500ns */
            sclh   = 0x01;  /* t_SCLH   = 250ns */
            sdadel = 0x00;  /* t_SDADEL = 0ns */
            scldel = 0x01;  /* t_SCLDEL = 250ns */
            break;
